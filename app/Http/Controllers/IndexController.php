<?php
/**
 * IndexController отображает (? и что-то делает с) главн. стр. сайта
 */
...
class IndexController extends SiteController
{
     ...
     * Отображает главн стр. пользовательской части
     *
    ...
    public function index()
    {
        ...
        //contentRightBar содержит готовый к отображению код прав. колонки
