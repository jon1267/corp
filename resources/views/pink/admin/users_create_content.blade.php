<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {{-- если без фасада Form:: на html-е то как-то так...
        <form action="{{ (isset($user->id)) ? route('admin.menus.update',['menus'=>$user->id]) : route('admin.menus.store') }} "
            method="post" class="contact-form" enctype="multipart/form-data">
        </form>
        --}}

        {!! Form::open(['url' => (isset($user->id)) ? route('admin.users.update',['users'=>$user->id]) : route('admin.users.store'),
